# -*- coding: utf-8 -*-
#from _conexion import removeConnection
...
def ejecutar():
    ...
    #naoRed,tts_service,sr_service,memory_service,motion_service = conectarNao()
    ...
    #internetRed = conectarInternet() #TODO: CAMBIE LUNES14
    ...
    while askCel:
        ...
        if (num_pal in admitidos_celular) and (num_prob >= prob_aceptable):
            ...
            if len(cel) == 9:
                ...
                tts_service.say("Diga confirmo para enviar el mensaje o no diga nada para volver a empezar") #TODO palabras diferentes
